...
import com.music.utils.Preferences;
import com.music.utils.ScreenUtils;
import com.music.utils.SystemUtils;
import com.music.utils.ToastUtils;
import com.music.utils.binding.Bind;
import com.music.widget.AlbumCoverView;
...
public class PlayFragment extends BaseFragment implements View.OnClickListener,
        ...
        LrcView.OnPlayClickListener, onMediaPlayerEventChanagerListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        AudioPlayer.getInstance().addMediaPlayerEventChanagerListener(this);
    }
    ...
    private void initSystemBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int top = ScreenUtils.getStatusBarHeight(getContext());
    ...
    private void onChangeImpl(MusicData music) {
        if (music == null) {
            return;
        }
    ...
    private void setCoverAndBg(MusicData music) {
    ...
    private void setLrc(final MusicData music) {
        if (music.getSourceType() == MusicData.sourceType.LOCAL) {
            String lrcPath = music.getLrcPath();//FileUtils.getLrcFilePath(music);
            if (!TextUtils.isEmpty(lrcPath)) {
                loadLrc(lrcPath);
            } else {
               /* new SearchLrc(music.getArtist(), music.getMusicName()) {
                    @Override
    ...
    public void onDestroy() {
        ...
        AudioPlayer.getInstance().removeMediaPlayerEventChanagerListener(this);
        super.onDestroy();
    }
}
